...
// Comment directives that opt a class in, or a method back out, of validation.
//
//   // @capnweb-validate                   enable a class
//   // @capnweb-validate {Cursor<string>}  enable with an explicit RPC surface
//   // @capnweb-validate-ignore            disable a method
//
// Directives are read from the leading comments of a class declaration or a
// class member, in both `//` and `/** */` form.
...
// the class's own type parameters are all in scope.
